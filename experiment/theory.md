...
<!-- With these elements any of twelve different linear process characteristics of Type 0, 1 and 2 may be established.
Every element produces a polarity inversion but the inverter may be included or not as necessary to produce the desired overall polarity.<br> <br>
-->
...
<!-- To avoid problems due to integrator drift an OFF position is provided on the integral action control in which the integral term is held at zero.<br> -->
