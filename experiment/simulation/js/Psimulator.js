...
/////for 50% band PB /////////////////////
 ...
 for (var t = math.round(math.multiply(math.add(nc,0),math.divide(tperiod,tmpv),10)); t <= math.round(math.multiply(math.add(math.multiply(nc,2),1),math.divide(axes.N,cyclehlfs))); t++) {
	...
	//for (var t = math.multiply(math.add(math.multiply(nc,2),1),math.divide(axes.N,cyclehlfs)); t<= math.multiply(2,math.divide(axes.N,cyclehlfs),math.add(((2*nc)/2),1)); t++) {
		for (t = math.round(math.multiply(math.add(math.multiply(nc,2),1),math.divide(axes.N,cyclehlfs))); t<= math.round(math.multiply(2,math.divide(axes.N,cyclehlfs),math.add(((2*nc)/2),1))); t++) {
